- [쿠버네티스의 이해 ( 시작 )](#쿠버네티스의-이해--시작-)
  - [쿠버네티스 어원](#쿠버네티스-어원)
  - [쿠버네티스와 같은 시스템이 필요한 이유](#쿠버네티스와-같은-시스템이-필요한-이유)
  - [컨테이너의 이해](#컨테이너의-이해)
    - [Kubernetes 의 이해](#kubernetes-의-이해)
      - [클러스터의 개념 이해하기](#클러스터의-개념-이해하기)
      - [마스터 노드 ( 컨트롤 플레인 )](#마스터-노드--컨트롤-플레인-)
        - [컨트롤 플레인](#컨트롤-플레인)
      - [워커 노드](#워커-노드)
      - [쿠버네티스에서 애플리케이션 실행](#쿠버네티스에서-애플리케이션-실행)
    - [쿠버네티스 사용의 장점](#쿠버네티스-사용의-장점)
