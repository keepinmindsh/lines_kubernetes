- [Section 12 - 배포에 대하여](#section-12---배포에-대하여)
  - [Cheat Sheet](#cheat-sheet)
  - [파드에서 실행 중인 애플리케이션 업데이트](#파드에서-실행-중인-애플리케이션-업데이트)
    - [오래된 파드를 삭제하고 새 파드로 교체](#오래된-파드를-삭제하고-새-파드로-교체)
    - [새 파드 기동과 이전 파드 삭제](#새-파드-기동과-이전-파드-삭제)
  - [레플리케이션 컨트롤러 자동 롤링 업데이트 수행](#레플리케이션-컨트롤러-자동-롤링-업데이트-수행)
    - [kubectl을 이용한 롤링 업데이트](#kubectl을-이용한-롤링-업데이트)
    - [파드에 의한 Rolling Update의 문제](#파드에-의한-rolling-update의-문제)
  - [애플리케이션을 선언적으로 업데이트하기 위한 디플로이먼트 사용하기](#애플리케이션을-선언적으로-업데이트하기-위한-디플로이먼트-사용하기)
    - [디플로이먼트](#디플로이먼트)
    - [디플로이먼트 생성](#디플로이먼트-생성)
    - [디플로이먼트 업데이트](#디플로이먼트-업데이트)
    - [디플로이먼트 롤백](#디플로이먼트-롤백)
    - [롤아웃 속도 제어](#롤아웃-속도-제어)
    - [롤아웃 프로세스 일시 중지](#롤아웃-프로세스-일시-중지)
    - [수정 버전 기록 제한](#수정-버전-기록-제한)
    - [잘못된 버전의 롤아웃 방지](#잘못된-버전의-롤아웃-방지)
